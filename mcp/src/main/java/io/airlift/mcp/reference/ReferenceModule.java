        ...
        implements Module
{
    ...
    @Singleton
    @Provides
    public McpStatelessSyncServer buildServer(ReferenceServerTransport transport, McpMetadata metadata, McpJsonMapper mcpJsonMapper, McpUriTemplateManagerFactory uriTemplateManagerFactory, Optional<SessionController> sessionController)
    {
